(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  function CallExpression(node, scope) {
      ...
      for (var i = 0; i < node.arguments.length; i++) {
          ...
          if (arg.type === 'SpreadElement') {
              ...
              var paramType = FunctionArgType$1(func.name, i, scope);
  ...
  function CallExpression$1(node, scope) {
      var func, object, key, thisObject, name_1, args, i, arg, _a, _b, param, paramType, superCall;
      return __generator(this, function (_c) {
          switch (_c.label) {
              case 0:
              ...
              case 9:
                  ...
                  return [3, 12];
              case 10: return [5, __values(evaluate$1(arg, scope))];
              case 11:
                  param = _c.sent();
                  paramType = FunctionArgType(func.name, i, scope);
