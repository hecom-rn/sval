(function (global, factory) {
  ...
  function CallExpression(node, scope) {
      ...
      for (let i = 0; i < node.arguments.length; i++) {
          ...
          if (arg.type === 'SpreadElement') {
              ...
              const paramType = FunctionArgType$1(func.name, i, scope);
              if (paramType === exports.TYPE.NUMBER && needNull2Zero$1(arg, scope)) {
                  param = param !== null && param !== void 0 ? param : 0;
              }
              else if (paramType === exports.TYPE.STRING && param) {
  ...
  function* CallExpression$1(node, scope) {
      ...
      for (let i = 0; i < node.arguments.length; i++) {
          ...
          if (arg.type === 'SpreadElement') {
              ...
              let param = yield* evaluate$1(arg, scope);
              const paramType = FunctionArgType(func.name, i, scope);
              if (paramType === exports.TYPE.NUMBER && needNull2Zero(arg, scope)) {
                  param = param !== null && param !== void 0 ? param : 0;
              }
              else if (paramType === exports.TYPE.STRING && param) {
                  param = param.toString();
  ...
  function FunctionArgType(name, argIndex, scope) {
      ...
      return (_b = (_a = funcTypeMap === null || funcTypeMap === void 0 ? void 0 : funcTypeMap[name]) === null || _a === void 0 ? void 0 : _a.argsType(argIndex)) !== null && _b !== void 0 ? _b : exports.TYPE.ANY;
  }
  ...
  function isStringConcat$1(leftValue, rightValue, node, scope) {
      const isLeftNumber = typeof leftValue === 'number' || isNumberField$1(node.left, scope) || isNullType$1(leftValue, node.left);
      const isRightNumber = typeof rightValue === 'number' || isNumberField$1(node.right, scope) || isNullType$1(rightValue, node.right);
      return !isLeftNumber || !isRightNumber;
  }
